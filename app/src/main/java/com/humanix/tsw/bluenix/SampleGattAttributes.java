...
public class SampleGattAttributes {
    ...
    public static String UUID_BLUEINNO_PROFILE_RECEIVE_UUIDD = "00002221-0000-1000-8000-00805f9b34fb";
    ...
    static {
        ...
        attributes.put(UUID_BLUEINNO_PROFILE_RECEIVE_UUIDD, BLUEINNO_PROFILE_RECEIVE);
    }
